...
import com.benchreadiness.interview.org.OrgContext;
...
/** Enforces {@link RequiresFeature}. OrgContext is already populated by HeaderAuthenticationFilter
 * by the time any controller method (and thus this advice) runs. */
@Aspect
@Component
