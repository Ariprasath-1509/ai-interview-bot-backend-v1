...
public class AiMatchingService {
    ...
    public AiMatchingService(OpenAiClient openAiClient, ComplianceServiceClient complianceServiceClient) {
    ...
    public Map<String, Object> matchCandidates(MatchingRequest request, String userId) {
        try {
            ...
            String response = openAiClient.chatMatching(prompt, candidatesJson);
